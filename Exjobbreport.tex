...
% Review of FE and FTJs from 2014. FTJ in 1971 -> forgotten
% FeRAMs commercially available.
...
% Overview of FE and its uses. Mention of HZO and its perks/drawbacks.
% First paper reporting on FE HZO.
...
% Demonstrating a functional FTJ (on Si)
...
can be amended with junction bilayers, reduced cycling voltage among other
things but one crucial limiting factor is the thermal stresses endured by the
device in the crystallization process.

% Foundations of FLA processing of HZO
% Successful integration in production environment (thermal budget and all
% using nanosecond laser annealing.)
\cite{oconnor2018stabilization}
\cite{grenouillet2020nanosecond}
