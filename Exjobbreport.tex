...
\begin{figure}
    \centering
    \includegraphics[width=0.50\textwidth]{fig/CV_hysteresis.png}
    \caption{Figure describing the basis of the CV method. Borrowed from A. E.
    Persson et.al. \cite{persson2020method}}
