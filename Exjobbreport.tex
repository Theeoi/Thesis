...
field even after an external electric field is removed. Much like a
ferromagnetic material, which most of us are familiar with, the small-scale
fields can be aligned from an external source in order to propagate and
...
has its own electric field strength and direction in 3D-space. The boundaries
between these domains are not set by physical properties of the material but is
changing depending on the electrical field orientation of the neighbouring
domains. 
% TODO: This might not be true! Check D. Damjanovic 'The science of hysteresis'
