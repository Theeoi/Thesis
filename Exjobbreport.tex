...
% Mål: Med FE förklarat, sammanställ allt i hur en FTJ ser ut och
% fungerar med banddiagram och allt. Inkorporera varför III-V är bra här!
...
\begin{figure}[htbp]
    ...
    \caption{Bandstructure of a MIM FTJ. Image taken from Garcia et.al. \cite{garcia2014ferroelectric}}
...
% direct tunneling --> Hög barriär. 
% Redogör för vilka typer av defekter vi vill åt och hur de påverkas av
...
depinning and pinning of the domains respectively. Initial cycling allows for
...
However, further cycling generates additional vacancies at the interfaces which
screens the bulk of the ferroelectric and makes it more difficult to reach the
coercive field of all domains. The generated vacancies can subsequently diffuse
into the bulk trapping charges which pins the domains from participating in the
switching. Further vacancy generation collects at the grain boundaries of the
HZO significantly increasing the leakage current until breakdown of the device
\cite{pesic2016physical}. Furthermore, a paper investigating the structural
properties of the integration of ferroelectric HZO on \ce{InAs} in 2016 showed
the diffusion of both \ce{In} and \ce{As} atoms through the HZO layer during
annealing which significantly affects performance of the device
\cite{kang2016structural}.

Both of these effects are related to the diffusion of defects during the
annealing step of the ferroelectric junction fabrication.
