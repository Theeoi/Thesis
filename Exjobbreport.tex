...
The remnant polarization and the coercive fields of these samples follow similar
patterns reaching a peak of \SI{20}{\joule\per\centi\meter\squared} and a
minimum of \SI{0.46}{\mega\volt\per\centi\meter} respectively at a peak
annealing temperature around \SI{711}{\celsius}. Higher temperature annealing
shows a degradation of these ferroelectric properties.

Figures \ref{fig:res_IntCPr} and \ref{fig:res_IntCEc} shows that the
described experimental process in \ref{ch:fab} is indeed a valid process for
