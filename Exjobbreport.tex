...
% \chapter*{Popular Science Summary}\vspace{-4em}
...
the discovery of ferroelectric hafnium oxide (\ce{HfO2}). Hafnium oxide was and
...
The orthorhombic phase of \ce{Hf_{1-x}Zr_xO2} (HZO) is reached through
...
\ce{Hf_{0.5}Zr_{0.5}O2}, where every other \ce{Hf} atom is replaced by \ce{Zr},
...
access the \ce{InAs} substrate (bottom electrode) a short-circuit was created
...
difference between the \ce{InAs} substrate and the probing electrode with a
broken oxide.
...
to collect at the \ce{HZO} grain boundaries increasing the leakage through the
