...
For sample series 4 and 5, tabulated in table \ref{tab:res_IntE} and
\ref{tab:res_NumD} respectively, the growth temperature during annealing was
...
\begin{table}[htbp]
    ...
    \begin{tabular}{rlccc}
        ...
        \multicolumn{1}{c}{FLA} & & & & \\
        Preheat Temperature & [\si{\celsius}] & 250 & 250 & 250 \\
        Peak Temperature & [\si{\celsius}] & \textbf{538} & \textbf{630} &
        \textbf{711} \\
...
The plotted data from sample series 4 is shown in figure \ref{fig:res_IntE}. 
